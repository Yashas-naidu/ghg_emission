...
@app.route('/api/carbon/stationary', methods=['POST'])
def carbon_stationary():
    try:
        # Get request data
        request_data = request.json
        ...
        # Set API endpoint
        ei_api_endpoint = f"{config_data['EI_BASE_URL']}/v2/carbon/stationary"
...
@app.route('/api/carbon/fugitive', methods=['POST'])
def carbon_fugitive():
    try:
        # Get request data
        request_data = request.json
        ...
        # Set API endpoint
        ei_api_endpoint = f"{config_data['EI_BASE_URL']}/v2/carbon/fugitive"
...
@app.route('/api/carbon/location', methods=['POST'])
def carbon_location():
    try:
        # Get request data
        request_data = request.json
        ...
        # Set API endpoint
        ei_api_endpoint = f"{config_data['EI_BASE_URL']}/v2/carbon/location"
...
@app.route("/api/carbon/market", methods=["POST"])
def carbon_market():
    try:
        # Get request data
        request_data = request.json
        ...
        # Set API endpoint
        ei_api_endpoint = f"{config_data['EI_BASE_URL']}/v2/carbon/market"
...
@app.route("/api/carbon/transport", methods=["POST"])
def carbon_transport():
    try:
        # Get request data
        request_data = request.json
        ...
        # Set API endpoint
        ei_api_endpoint = f"{config_data['EI_BASE_URL']}/v2/carbon/transportation_and_distribution"
